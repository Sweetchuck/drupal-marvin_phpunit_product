...
class RoboFile extends Tasks implements LoggerAwareInterface, ConfigAwareInterface {
  ...
  protected function initEnvironmentTypeAndName() {
    $this->environmentType = getenv($this->getEnvVarName('environment_type')) ?: NULL;
    $this->environmentName = getenv($this->getEnvVarName('environment_name')) ?: NULL;
  ...
  /**
   * @phpstan-param php-definition $php
   *
